...
export default function BlogPage() {
  ...
  return (
    <div
      ...
      className="min-h-screen bg-[#F5F5F2] text-[#14141A] antialiased"
    >
      {/* ── Hero ── */}
      <div className="relative overflow-hidden bg-[#14141A] text-white border-b-2 border-[#14141A]">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl py-16 lg:py-20 text-center relative z-10">
          ...
          >
            ...
            <h1
              className="text-4xl md:text-5xl mb-4 leading-[0.98]"
              style={{ fontFamily: DISPLAY }}
            >
              INSIGHTS, TIPS
              <br />
              &amp; <span className="bg-[#FF3D57] px-2">STORIES</span>
            </h1>
            <p className="text-white/70 text-base md:text-lg max-w-xl mx-auto">
              Career advice, cloud tutorials, and behind-the-scenes updates from
              the XourceBase team.
            </p>
          </motion.div>
        </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl py-14">
        {loading ? (
          ...
          >
            ...
            <h2
              className="text-2xl font-extrabold text-[#14141A] mb-3"
              style={{ fontFamily: DISPLAY }}
            >
              NO POSTS YET
            </h2>
