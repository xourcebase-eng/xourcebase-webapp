...
const testimonials = [
  {
    ...
    accentBg: '#C6FF3D',
    quote:
      "XourceBase's Career Accelerator completely changed my trajectory. Hands-on DevOps projects and certification guidance helped me land a Cloud Engineer role with a 180% salary hike.",
    name: 'Saurabh Pandey',
  ...
  },
  {
    ...
    accentBg: '#3D5AFF',
    quote:
      'As a fresher I was terrified of interviews. The Communication program rebuilt my confidence. Placed in an international BPO within just 2 months of completing the course.',
    name: 'Satyam Singh',
    role: 'Process Associate at Concentrix',
  ...
  },
  {
    ...
    accentBg: '#FF3D57',
    quote:
      'Switching careers to DevOps seemed impossible until I joined XourceBase. The mentors guided me step by step. Cleared my AWS certification on the very first attempt.',
    name: 'Ganesh Pawar',
    role: 'DevOps Engineer at Gigmos',
  ...
  },
  {
    ...
    accentBg: '#FFB800',
    quote:
      'The 1:1 mentorship is what sets XourceBase apart. My mentor reviewed my code weekly and helped me build a portfolio that impressed every interviewer. Got 3 offers in a single month.',
    name: 'Mehul Bapse',
    role: 'Cloud Support Engineer at TCS',
...
const upcomingWorkshops = [
  {
    ...
    accentBg: '#C6FF3D',
    description:
      'A hands-on introduction to version control with Git and collaboration on GitHub — commits, branching, merging, and pull requests.',
    isFree: true,
    status: 'open',
  ...
  },
  {
    ...
    accentBg: '#FF3D57',
    description:
      'Master the STAR method, voice modulation, and body language. Live mock interview at the end.',
    isFree: true,
    status: 'coming_soon',
    opensOn: 'May 15, 2025',
  },
...
const upcomingTrainings = [
  {
    ...
    accentBg: '#C6FF3D',
    description:
      'AWS, Azure, Kubernetes, Terraform, and CI/CD with real-world capstone projects and placement support.',
  ...
  },
  {
    ...
    accentBg: '#FF3D57',
    description:
      'Voice & non-voice training, soft skills, and personality development to launch your BPO career.',
  ...
  },
  {
    ...
    accentBg: '#3D5AFF',
    description:
      'Learn SQL, Python, Spark, and cloud data pipelines. Build a portfolio-ready project on AWS Redshift.',
          ...
          >
            <div
              className={`w-4 h-4 rounded-full border-2 border-white ${
                i === 0 ? 'bg-[#C6FF3D]' : 'bg-transparent'
              }`}
            />
            <span
              className="text-[10px] sm:text-xs font-bold tracking-widest text-white/80"
              style={{ fontFamily: MONO }}
            >
              {stage}
            </span>
...
function SectionHeader({
  ...
  return (
    ...
    >
      ...
      <motion.p variants={fadeInUp} className="text-lg text-[#14141A]/60 max-w-2xl mx-auto">
        {subtitle}
      </motion.p>
    </motion.div>
  );
    ...
    >
      ...
      <div className="pl-8 pr-7 pt-7 pb-6 flex flex-col flex-1">
        <div className="flex items-center justify-between mb-4 gap-2">
          ...
          <span
            className="inline-flex items-center gap-1 text-[11px] font-bold tracking-wide px-2 py-0.5 border border-[#14141A]/70 text-[#14141A] uppercase ml-auto"
            style={{ fontFamily: MONO }}
          >
        ...
        {isComingSoon ? (
          <span className="inline-flex items-center justify-center w-full px-5 py-3 text-sm font-bold tracking-wide text-[#14141A]/40 border-2 border-[#14141A]/20 cursor-not-allowed">
            COMING SOON
          </span>
        ) : (
          <Link
      ...
      <div className="pl-8 pr-7 pt-7 pb-6 flex flex-col flex-1">
        ...
        <div className="flex flex-wrap gap-1.5">
          {t.topics.slice(0, 4).map((topic) => (
            <span
              key={topic}
              className="text-[11px] bg-[#F5F5F2] border border-[#14141A]/15 text-[#14141A]/70 px-2 py-1 font-medium"
            >
              {topic}
            </span>
          ))}
          ...
          <motion.div initial="hidden" animate="visible" variants={containerVariants}>
            ...
            */}
            ...
            <motion.p variants={fadeInUp} className="text-base md:text-lg text-white/60 mb-10 max-w-xl">
              Industry-expert workshops and hands-on training in Cloud, DevOps, Data &
              Communication — with real projects, mock interviews, and placement support.
            </motion.p>
            ...
            <motion.div
              variants={fadeInUp}
              className="flex flex-wrap gap-x-8 gap-y-3 text-sm text-white/70"
            >
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 gap-4">
              <div>
                <motion.span
                  variants={fadeInUp}
                  className="inline-block text-[11px] font-bold uppercase tracking-[0.2em] bg-[#C6FF3D] text-[#14141A] px-3 py-1.5 mb-4"
                  style={{ fontFamily: MONO }}
                >
                  Live Events
                </motion.span>
                <motion.h2
                  variants={fadeInUp}
                  className="text-3xl md:text-4xl text-[#14141A]"
                  style={{ fontFamily: DISPLAY }}
                >
                  UPCOMING WORKSHOPS
                </motion.h2>
                <motion.p
                  variants={fadeInUp}
                  className="mt-3 text-base text-[#14141A]/60 max-w-xl"
                >
                  Free and paid live sessions led by industry experts. Limited seats —
              ...
              <motion.div variants={fadeInUp} className="hidden sm:block">
                <Link
                  href="/workshops"
                  className="inline-flex items-center gap-2 px-6 py-3 text-xs font-bold tracking-wide border-2 border-[#14141A] text-[#14141A] hover:bg-[#14141A] hover:text-white transition-all whitespace-nowrap"
                  style={{ fontFamily: MONO }}
                >
            ...
            >
              {upcomingWorkshops.map((w) => (
                <WorkshopPreviewCard key={w.id} w={w} />
              ))}
            </motion.div>
            <div className="mt-10 flex justify-center sm:hidden">
              <Link
                href="/workshops"
                className="inline-flex items-center gap-2 px-8 py-3.5 text-sm font-bold tracking-wide bg-[#14141A] text-white hover:bg-black transition-all"
              >
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 gap-4">
              <div>
                <motion.span
                  variants={fadeInUp}
                  className="inline-block text-[11px] font-bold uppercase tracking-[0.2em] bg-[#FF3D57] text-white px-3 py-1.5 mb-4"
                  style={{ fontFamily: MONO }}
                >
                  Coming Soon
                </motion.span>
                ...
                <motion.p
                  ...
                  className="mt-3 text-base text-[#14141A]/60 max-w-xl"
                >
                  Multi-week cohort programs with mentorship, capstone projects, and
                  placement support — opening soon.
                </motion.p>
              </div>
              <motion.div variants={fadeInUp} className="hidden sm:block">
                <Link
            ...
            >
              {upcomingTrainings.map((t) => (
                <TrainingPreviewCard key={t.id} t={t} />
              ))}
            </motion.div>
            <div className="mt-10 flex justify-center sm:hidden">
              <Link
      ...
      <section className="py-20 px-4 sm:px-6 bg-[#F5F5F2]">
        <div className="container mx-auto max-w-7xl">
          <SectionHeader
            ...
            badgeBg="#C6FF3D"
            title="REAL SKILLS. REAL RESULTS. REAL JOBS."
            subtitle="We don't just teach — we prepare you to succeed in today's competitive job market."
          />
          <motion.div
            initial="hidden"
            whileInView="visible"
      ...
      <section className="py-20 px-4 sm:px-6 bg-white border-y-2 border-[#14141A]">
        <div className="container mx-auto max-w-7xl">
          <SectionHeader
            ...
            subtitle="Practical support that actually moves you closer to your dream job — not just coursework."
          />
          <motion.div
            initial="hidden"
            whileInView="visible"
      ...
      <section className="py-20 px-4 sm:px-6 bg-[#F5F5F2]">
        <div className="container mx-auto max-w-7xl">
          <SectionHeader
            ...
            badgeBg="#3D5AFF"
            badgeText="#FFFFFF"
            title="CLEAR INTERVIEWS WITH CONFIDENCE"
            subtitle="Master every stage of the interview process with our proven 5-pillar system."
          />
          <motion.div
            initial="hidden"
            whileInView="visible"
      ...
      <section className="py-24 px-4 sm:px-6 bg-[#14141A] overflow-hidden relative border-y-2 border-[#14141A]">
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          >
            <motion.span
              variants={fadeInUp}
              className="inline-block text-[11px] font-bold uppercase tracking-[0.2em] bg-white/10 text-white/70 px-3 py-1.5 mb-5"
              style={{ fontFamily: MONO }}
            >
              Student Outcomes
            </motion.span>
            ...
            <motion.p variants={fadeInUp} className="text-lg text-white/50 max-w-2xl mx-auto">
              Real results from real students — not just numbers, but stories of
              transformation.
            </motion.p>
          </motion.div>
          ...
          <div className="relative">
            <Swiper
              ...
              pagination={{
                ...
                bulletClass:
                  'swiper-pagination-bullet !bg-white/30 !opacity-100 !w-2 !h-2 !rounded-none',
                ...
                <SwiperSlide key={s.name} className="h-auto">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 pt-4 border-t border-white/10">
                      <div
                        className="w-10 h-10 border-2 border-white/20 flex items-center justify-center text-white font-bold text-sm shrink-0"
                        style={{ background: s.accentBg, color: '#14141A' }}
                      >
                        {s.initials}
                      </div>
                      <div>
      ...
      <section className="relative py-24 px-4 sm:px-6 bg-[#F5F5F2] overflow-hidden">
        ...
        <div className="container mx-auto max-w-3xl text-center relative z-10">
          ...
          >
            <motion.span
              variants={fadeInUp}
              className="inline-block bg-[#FF3D57] text-white text-[11px] font-bold uppercase tracking-[0.2em] px-3 py-1.5 mb-6"
              style={{ fontFamily: MONO }}
            >
            ...
            <motion.p
              variants={fadeInUp}
              className="text-base md:text-lg text-[#14141A]/60 mb-3 max-w-lg mx-auto"
            >
              Join thousands of students who accelerated their careers with XourceBase.
            </motion.p>
            <motion.p
              variants={fadeInUp}
              className="text-sm text-[#14141A]/40 mb-9 font-semibold"
            >
            ...
            >
              <Link
                href="/workshops"
                className="inline-flex items-center justify-center gap-3 px-8 py-4 text-sm font-bold tracking-wide bg-[#14141A] text-white hover:bg-black transition-all"
              >
                <BookOpen className="w-4 h-4" /> JOIN A WORKSHOP FREE
              </Link>
              <Link
                href="/trainings"
                className="inline-flex items-center justify-center gap-3 px-8 py-4 text-sm font-bold tracking-wide border-2 border-[#14141A] text-[#14141A] hover:bg-[#14141A] hover:text-white transition-all"
              >
                EXPLORE TRAINING <ArrowRight className="w-4 h-4" />
              </Link>
            </motion.div>
