      ...
      <div className="flex items-center justify-between relative">
        ...
        {STAGES.map((stage, i) => (
          ...
          >
            ...
            />
            <span
              className="text-[11px] sm:text-xs font-bold tracking-widest text-[#14141A]"
      ...
      <div className="pl-8 pr-7 pt-7 pb-6 flex flex-col flex-1">
        ...
        <div className="flex items-start justify-between gap-3 mb-5">
          ...
          <div className="flex flex-col items-center leading-none flex-shrink-0 pr-6">
            <span
              className="text-3xl font-bold text-[#14141A]"
              style={{ fontFamily: "'Space Grotesk', sans-serif" }}
            >
              {String(t.durationWeeks).padStart(2, '0')}
            </span>
            <span className="text-[10px] font-bold tracking-widest text-[#14141A]/50">
              WEEKS
            </span>
          </div>
        </div>
        ...
        <p
          ...
          style={{
            color: accent.bg === '#FFFFFF' ? '#14141A' : accent.bg,
        ...
        {/* Title + subtitle */}
        <h3
          className="text-xl font-extrabold text-[#14141A] mb-1 leading-tight"
        ...
        {/* Meta row */}
        <div className="flex items-center gap-1.5 text-xs text-[#14141A]/50 font-semibold mt-auto">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <motion.div initial="hidden" animate="visible" variants={containerVariants}>
            ...
            <motion.p variants={fadeInUp} className="text-base md:text-lg text-[#14141A]/60 mb-10 max-w-xl">
              Multi-week cohort sprints with 1:1 mentorship, capstone projects, and
              placement support — for students, freshers, and working professionals
              ready to move.
            </motion.p>
            ...
            <motion.div
              variants={fadeInUp}
              className="grid grid-cols-3 max-w-xl border-2 border-[#14141A] divide-x-2 divide-[#14141A]"
            >
              {[
                ...
                <div key={s.label} className="px-4 py-3 text-center">
                  <p
                    className="text-2xl sm:text-3xl font-bold text-[#14141A]"
                    style={{ fontFamily: "'Space Grotesk', sans-serif" }}
                  >
                    {s.value}
                  </p>
                  <p className="text-[10px] font-bold tracking-widest text-[#14141A]/50 mt-0.5">
                    {s.label}
                  </p>
                </div>
              ))}
                ...
                <button
                  ...
                  className={`text-xs font-bold tracking-wide px-3 py-1.5 border-2 border-[#14141A] transition-colors duration-150 ${
                    category === c
                      ...
                      : 'bg-white text-[#14141A] hover:bg-[#14141A]/5'
                  }`}
                  style={{ fontFamily: "'Space Grotesk', sans-serif" }}
                >
                  {c.toUpperCase()}
              ...
              {LEVELS.map((l) => (
                <button
                  ...
                  className={`text-xs font-bold tracking-wide px-3 py-1.5 border-2 transition-colors duration-150 ${
                    level === l
                      ? 'bg-[#FF3D57] text-white border-[#14141A]'
                      : 'bg-white text-[#14141A] border-[#14141A]/20 hover:border-[#14141A]'
                  }`}
                  style={{ fontFamily: "'Space Grotesk', sans-serif" }}
                >
                  {l.toUpperCase()}
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="mb-8 flex items-center justify-between flex-wrap gap-2">
            <p className="text-sm text-[#14141A]/60">
              ...
              {trainings.length} programs
            </p>
            <p className="text-xs text-[#14141A] font-bold tracking-wide">
      ...
      <section className="py-20 px-6 bg-[#14141A] text-white relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-3xl text-center relative z-10">
          ...
          >
            ...
            >
              Book a free 1:1 career guidance call with our mentors and get a
